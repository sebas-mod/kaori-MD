...
export { sendText, sendReply, sendImage, sendVideo, sendAudio, sendSticker, sendDocument, sendContact, sendLocation, sendReact, sendWithTyping, sendToMultiple, forwardMessage, deleteMessage, createQuotedDummy, sendWithPreview, sendMenu }