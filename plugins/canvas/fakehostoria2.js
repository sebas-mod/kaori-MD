...
const pluginConfig = {
  name: "fakestory2",
  alias: ["fstory2", "igstory2", "historiafalsa2"],
  category: "canvas",
  description: "Crea una historia de Instagram falsa con una imagen completa",
  usage: ".fakestory2 <nombre>",
  example: ".fakestory2 Misaki (responde a una imagen)",
  isOwner: false,
  isPremium: false,
  isGroup: false,
  isPrivate: false,
