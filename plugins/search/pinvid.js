...
const pluginConfig = {
    ...
    category: 'search',
    description: 'Buscar videos de Pinterest (álbum)',
    usage: '.pinvid <query>',
...
async function handler(m, { sock }) {
    ...
    if (!query) {
        return m.reply(
            `📌 *ʙᴜ́sǫᴜᴇᴅᴀ ᴅᴇ ᴠɪᴅᴇᴏs ᴇɴ ᴘɪɴᴛᴇʀᴇsᴛ*\n\n` +
    ...
    try {
            ...
            try {
                ...
                if (videoUrl.includes('.m3u8')) {
                    ...
                    try {
                        ...
                        console.log(`[PinVid] FFmpeg error para video ${i + 1}:`, ffmpegErr.message)
                        continue
                    }
                } else {
                ...
                console.log(`[PinVid] Falló al procesar el video ${i + 1}:`, vidErr.message)
            }
        }
        ...
        try {
            ...
            console.log('[PinVid] Error en mensaje de álbum, enviando individualmente:', albumErr.message)
